<x-app-layout>
    <div class="space-y-6">
        <x-admin.page-header
            ...
            description="Bulk import students from a spreadsheet or export your student records." />
            ...
            <div class="card">
                ...
                <div class="border-t border-slate-100 px-6 py-4">
                    ...
                    <div class="mt-2 flex flex-wrap gap-2">
                        @foreach (['surname', 'first_name', 'middle_name', 'foundation_number', 'jupeb_number', 'examination_number', 'subject_one', 'subject_two', 'subject_three'] as $column)
