...
<div class="flex items-center gap-3">
    ...
    <div class="min-w-0 flex-1">
        <a href="{{ route('student.profile') }}" wire:navigate
            class="block truncate text-sm font-semibold text-white hover:text-emerald-300 transition">
            {{ auth()->user()->name }}
        </a>
        <p class="truncate text-[11px] text-primary-200 capitalize">Student</p>
    </div>
